...
module ibex_id_stage #(
    ...
    // spm_lsu
    input   logic                     spm_data_valid_i,
    input   logic [31:0]              regfile_wdata_spm_i,
    output  logic                     spm_lsu_o,
    output  logic                     mem_spm_id_o,
    output  logic                     spm_reg_id_o,
    output  logic                     del_spm_id_o,
    output  logic   off_base_id_o,
    output  logic   spm2_reg_id_o,            
...
`endif
  ...
  typedef enum logic [1:0] {RF_LSU, RF_SPM, RF_EX} select_e;
...
// immediate for CSR manipulatin (zero extended)
  ...
  always_comb begin
    ...
    end else if (select_data_rf == RF_SPM) begin 
      regfile_wdata_mux = regfile_wdata_spm_i;    
...
`endif
  ...
  assign multdiv_int_en  = mult_int_en | div_int_en;
    ...
    assign spm_lsu_o            = spm_lsu_sig;
    assign mem_spm_id_o         = mem_spm_sig;
    assign spm_reg_id_o         = spm_reg_sig;
    assign del_spm_id_o         = del_spm_id;
    assign   off_base_id_o      = off_base_id;
    assign   spm2_reg_id_o      = spm2_reg_id;       
  ///////////// 
  // Decoder //
  /////////////
  ...
  ibex_decoder #( .RV32M ( RV32M ) ) decoder_i (
      ...
      //to spm_lsu
      .spm_inst_o                      ( spm_lsu_sig               ),
      .mem_spm_o                       ( mem_spm_sig               ),
      .spm_reg_o                       ( spm_reg_sig               ),
      .spm_del_o                       ( del_spm_id                ),
      .off_base_o                      ( off_base_id ),
      .spm2_reg_o                      ( spm2_reg_id ), 
  ...
  always_comb begin : id_wb_fsm
    ...
    unique case (id_wb_fsm_cs)
      ...
      IDLE: begin
        ...
        branch_mux_dec = 1'b1;
        unique case (1'b1)
            spm_reg_sig: begin // reading data from spm
                regfile_we      = 1'b1;
      ...
      WAIT_MULTICYCLE: begin
        if (ex_ready_i) begin
          ...
          end else if ( spm_reg_sig || spm2_reg_id ) begin
            select_data_rf = RF_SPM;
          end
        end else begin
          regfile_we      = 1'b0;
          instr_multicyle = 1'b1;
