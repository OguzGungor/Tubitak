...
module ibex_decoder #(
    ...
    // spm_lsu
    output logic                    spm_inst_o, // UNUSED
    output logic                    mem_spm_o,
    output logic                    spm_reg_o,
    output logic                    spm_del_o,
    output logic    off_base_o,
    output logic    spm2_reg_o,     
    
    output logic                    data_sign_ext_spm_o, // UNUSED
    output logic [1:0]              data_type_spm_o      // UNUSED
);
    ...
    unique case (opcode)
      ...
      OPCODE_SPM: begin
        case ( instr_rdata_i[14:12] ) 
            3'b000: begin       // SPMREG 
                spm_inst_o      = 1'b1;
                spm_reg_o       = 1'b1;     // stays high for entire load_stall!
                regfile_we      = 1'b1;
                ...
                imm_b_mux_sel_o     = IMM_B_I;
                // sign/zero extension
                data_sign_ext_spm_o = ~instr_rdata_i[14];
                // load size
                data_type_spm_o = 2'b00; // LW  
            end   
            3'b010: begin       // DELSPM
                spm_del_o       = 1'b1;
                spm_inst_o      = 1'b1;
            ...
            3'b011: begin       // SPMDATAB
                off_base_o       = 1'b1;
                spm_inst_o      = 1'b1;
                regfile_we      = 1'b0;
                alu_operator_o  = ALU_ADD;   // Add                  
            end
            3'b100: begin       // SPMDATAREG
                spm_inst_o      = 1'b1;
                spm2_reg_o      = 1'b1;     // stays high for entire load_stall!
                regfile_we      = 1'b1;
                // offset from immediate
                alu_operator_o      = ALU_ADD;
                alu_op_b_mux_sel_o  = OP_B_IMM;
      ...
      OPCODE_OP: begin  // Register-Register ALU operation
        ...
        //if (instr_rdata_i[31]) begin
          //illegal_insn_o = 1'b1;
        if (!instr_rdata_i[28]) begin // non bit-manipulation instructions
